 ...
 * 
 * Triggers automated Puppeteer workflow:
 * 1. Logs into the app using credentials from .env
 * 2. Navigates to Sales Analytics page
 ...
 * 6. Downloads the PDF as "Sales_Report.pdf"
 */
const ShortcutButton: React.FC = () => {
    ...
    const handleShortcut = async () => {
        setIsLoading(true);
        try {
            console.log('⚡ Starting shortcut automation...');
            ...
            console.log('✅ Shortcut complete - PDF downloaded');
    ...
    return (
        <button
            ...
            title="Automated export: Login → Sales Analytics → Screenshot (DPR 2.0, 50% zoom) → PDF"
        >
