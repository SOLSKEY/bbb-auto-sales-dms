...
const SummaryCard: React.FC<{ title: string; children: React.ReactNode; className?: string }> = ({ title, children, className = '' }) => (
     <div className={`glass-card p-4 flex flex-col justify-between ${className}`}>
        <div>
                            ...
                            <div>
                                ...
                                <div className="mt-2 space-y-2">
                                     <div className="grid grid-cols-2 gap-2 items-center">
                                        <label className="text-xs text-secondary">Total ADIMS</label>
                                     ...
                                     <div className="grid grid-cols-2 gap-2 items-center">
                                        <label className="text-xs text-secondary">Late Fees</label>
